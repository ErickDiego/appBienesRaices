...
{
    public class InfoBorough
    {
        public string propertyTitle { get; set; }
        public DateTime publicationDate { get; set; }
        public InfoCurency currencySale { get; set; }
        public InfoCurency currencyRent { get; set; }
        public InfoCurency currencySeasonalRental { get; set; }
        public string priceSaleFormatted { get; set; }
        public string priceRentFormatted { get; set; }
        public User user { get; set; }
        public Characteristics characteristics { get; set; }
        public List<PropertyMedium> propertyMedia { get; set; }
